...
$(document).ready(function()
	 {		
		...
		{
			var ki = $(this).val();
			if(ki == '1110111111111111011111111102011110111111111110112011102')
			{
				...
				$('#rew_ch_val').text("236.4 th ha");
				$('#con_ch_val').text("5.0 th ha");		
				$('#bio_ch_val').text("14.0 th ha");
				
			}
			else if(ki == '3330333333333333033333333302033330333333333330332033302')
			{                
				...
				$('#c32l4').css('background-color','transparent');
				/*$('#c_growth a').css('background-color','#EFDD60');
				$('#a_growth a').css('background-color','#EFDD60');
				$('#b_growth a').css('background-color','#EFDD60');*/
				
				$('#rew_ch_val').text("638.5 th ha");
				$('#con_ch_val').text("37.9 th ha");		
				$('#bio_ch_val').text("27.1 th ha");
				
			}
			else if(ki == '4440444444444444044444444402044440443444444440442044402')
			{
				...
				$('#rew_ch_val').text("638.8 th ha");
				$('#con_ch_val').text("48.8 th ha");		
				$('#bio_ch_val').text("47.1 th ha");
			}
			else if(ki == '2220222222222222022222222202022220222222222220222022202')
			{
				$('#c32l1').css('background-color','#FFAE55');
				$('#c32l2').css('background-color','#FFAE55');
				$('#c32l3').css('background-color','transparent');
				...
				$('#rew_ch_val').text("407.0 th ha");
				$('#con_ch_val').text("36.0 th ha");		
				$('#bio_ch_val').text("18. th ha");
			}
			else if(ki == '2220222222222222022222222202022220222222221120222022202')
			{
				$('#c32l2').css('background-color','#FFAE55');
				$('#c32l1').css('background-color','#FFAE55');
			...
			else if(ki == '4440444444444444044444444401044440443444444440442044402')
			{
				$('#c32l2').css('background-color','#92C979');
				$('#c32l1').css('background-color','#92C979');
			}
			...
			else if(ki == '11201212424244420323233222020222402422222211202420242022222')
			{
				$('#c32l1').css('background-color','#92C979');
				$('#c32l2').css('background-color','#92C979');
				$('#c32l3').css('background-color','#92C979');
				...
				$('#rew_ch_val').text("638.8 th ha");
				$('#con_ch_val').text("5.7 th ha");		
				$('#bio_ch_val').text("21.2 th ha");
			}
			else if(ki == '22202222223233320223223222020222202222222211202220222022222')
			{
				$('#c32l1').css('background-color','#FFAE55');
				$('#c32l2').css('background-color','#FFAE55');
				...
				$('#rew_ch_val').text("610.2 th ha");
				$('#con_ch_val').text("36.0 th ha");		
				$('#bio_ch_val').text("18.8 th ha");
			}
			else if(ki == '11104422424244420414314222020444404422242442404420442022222')
			{
				$('#c32l1').css('background-color','#92C979');
				$('#c32l2').css('background-color','#92C979');
				$('#c32l3').css('background-color','#92C979');
				...
				$('#rew_ch_val').text("638.8 th ha");
				$('#con_ch_val').text("32.7 th ha");		
				$('#bio_ch_val').text("41.1 th ha");
			}
			else if(ki == '3320332332323333033333333302033330333333333330332033302')
			{
				$('#c32l1').css('background-color','#EFDD60');
				$('#c32l2').css('background-color','#EFDD60');
				$('#c32l3').css('background-color','#EFDD60');
				...
				$('#c_growth a').css('background-color','#FFAE55');
				$('#a_growth a').css('background-color','#FFAE55');
				$('#b_growth a').css('background-color','white');
...
$(document).ready(function()
{
	...
	$("#pathway_option").change(function()
	{
		...
		else if(vals == '22202222223233320223223222020222202222222211202220222022222') /*---------State Vision Pathway--------*/
		{
				$('#trans_range').val('3');
			$('.tran_val').html('3'); 
		...
		else if(vals == '11104422424244420414314222020444404422242442404420442022222') /*---------Re Push and Low Emissions Pathways --------*/
		{
			...
			else if(vals == '11201212424244420323233222020222402422222211202420242022222') /*--------Maximum RE and Electic Vehicle Pathway--------*/
		{
				$('#trans_range').val('3');
			$('.tran_val').html('3'); 
